...
import { useBaseEzethWethLp } from "../../../hooks/base/useBaseEzethWethLp";
...
// Import JSON file
import baseEzethWethChartData from "../../../../../data/base/BaseEzethWethChartTicks.json";

export function BaseEzethWethBarGraph() {
  const { loading, fetchBaseEzethWethLp } = useBaseEzethWethLp();
  const { theme } = useTheme();

  const chartData = baseEzethWethChartData.map((tick: any) => {
    return {
        ...
        {loading ? (
          ...
          >
            ...
            >
              ...
              />
              <Bar dataKey="liquidityActive" barSize={5} fill="#90D5FF">
