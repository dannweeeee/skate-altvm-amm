...
import { useBaseEthUsdcLp } from "../../../hooks/base/useBaseEthUsdcLp";
...
// Import JSON file
import baseEthUsdcChartData from "../../../../../data/base/BaseEthUsdcChartTicks.json";

export function BaseEthUsdcBarGraph() {
  const { loading, fetchBaseEthUsdcLp } = useBaseEthUsdcLp();
  const { theme } = useTheme();

  const chartData = baseEthUsdcChartData.map((tick: any) => {
    return {
