...
import { useEthereumEthUsdcLp } from "../../../hooks/ethereum/useEthereumEthUsdcLp";
...
// Import JSON file
import ethereumEthUsdcChartData from "../../../../../data/ethereum/EthereumEthUsdcChartTicks.json";

export function EthereumEthUsdcBarGraph() {
  const { loading, fetchEthereumEthUsdcLp } = useEthereumEthUsdcLp();
  const { theme } = useTheme();

  const chartData = ethereumEthUsdcChartData.map((tick: any) => {
    return {
