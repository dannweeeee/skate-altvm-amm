...
import { useAggregatedEzethWethLp } from "../../../hooks/aggregated/useAggregatedEzethWethLp";
...
// Import JSON file
import aggregatedEzethWethChartData from "../../../../../data/aggregated/AggregatedEzethWethChartTicks.json";

export function AggregatedEzethWethBarGraph() {
  const { loading, fetchAggregatedEzethWethLp } = useAggregatedEzethWethLp();
  const { theme } = useTheme();

  const chartData = aggregatedEzethWethChartData.map((tick: any) => {
    return {
