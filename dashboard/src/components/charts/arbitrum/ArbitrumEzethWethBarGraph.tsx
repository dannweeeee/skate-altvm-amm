...
import { useArbitrumEzethWethLp } from "../../../hooks/arbitrum/useArbitrumEzethWethLp";
...
// Import JSON file
import arbitrumEzethWethChartData from "../../../../../data/arbitrum/ArbitrumEzethWethChartTicks.json";

export function ArbitrumEzethWethBarGraph() {
  const { loading, fetchArbitrumEzethWethLp } = useArbitrumEzethWethLp();
  const { theme } = useTheme();

  const chartData = arbitrumEzethWethChartData.map((tick: any) => {
    return {
