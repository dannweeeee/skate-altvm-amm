...
import {
  ...
  ARBITRUM_UNISWAP_V3_FACTORY_CONTRACT_ADDRESS,
  ARBITRUM_WETH_TOKEN,
} from "./constants";
...
const getAbi = (address: string) =>
  address.toLowerCase() === ARBITRUM_WETH_TOKEN.address.toLowerCase()
    ? WETH_ABI
    : ERC20_ABI;
...
export async function getArbitrumEzethWethPoolSlippage(
  tokenIn: any,
  tokenOut: any,
  fee: any,
  amountIn: any
